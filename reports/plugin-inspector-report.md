...
| ---------------- | -------- | -------------- | --------------------------- | ------------------------------ | ------------------ |
| openclaw-gh-sync | high     | plugin-runtime | gateway_start, gateway_stop | definePluginEntry, registerCli | -                  |
...
| ---------------- | ----------------------- | ----- | -------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------- | ------------- |
| openclaw-gh-sync | seam-inventory          | log   | observed 2 hooks, 2 registrations, and 0 manifest contracts                      | hook:gateway_start, hook:gateway_stop, registration:definePluginEntry, registration:registerCli | -             |
| openclaw-gh-sync | hook-names-present      | log   | all observed hooks exist in the target OpenClaw hook registry                    | gateway_start, gateway_stop                                                                     | -             |
| openclaw-gh-sync | api-registrars-present  | log   | all observed api.register* calls exist in the target OpenClaw plugin API builder | registerCli                                                                                     | -             |
| openclaw-gh-sync | sdk-exports-present     | log   | all observed plugin SDK imports exist in target OpenClaw package exports         | openclaw/plugin-sdk/plugin-entry                                                                | -             |
| openclaw-gh-sync | manifest-fields-checked | log   | plugin manifest fields were compared with target OpenClaw manifest types         | openclaw.plugin.json                                                                            | -             |
| openclaw-gh-sync | package-metadata        | log   | selected package metadata for plugin contract checks                             | package.json, @liwmj/openclaw-gh-sync, version:0.6.19                                           | -             |
